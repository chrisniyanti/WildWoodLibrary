...
<html lang="en">
  <head>
    ...
    <title>Edit Admin - WildWood Library</title><link rel="shortcut icon" href="img/logo.png">
     ...
     <section id="main-content">
          <section class="wrapper"> 
                ...
                <div class="col-lg-9">
                  ...
                  <br>
                  <br>
                  <center><h1>Edit Admin Data</h1></center>
                    <?php 
                      include 'connection.php';
                      $query=mysqli_query ($conn, "SELECT * FROM tb_admin WHERE admin_id='$_GET[admin_id]'");
...
<!--main content start-->
      <section id="main-content form">     
             <div class="row">   
                        <div class="white-box">
                            <center><h3><i class="glyphicon glyphicon-user"></i>&nbspForm Edit Admin&nbsp<i class="glyphicon glyphicon-user"></i></h3><p>Please, input the correct and valid data</p></center>
                            <br>    
                            <form enctype="multipart/form-data" class="form-horizontal form-material" method="POST" action="updateAdminexe.php">
                                <div class="form-group">
                                    <label class="col-md-12">ID</label>
                                    <div class="col-md-12">
                                        <input type="text" name="admin_id" class="form-control" placeholder="admin ID" value="<?php echo $admin_id; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                    <input type="text" name="admin_name" class="form-control" placeholder="admin name" required value="<?php echo $name; ?>" required>
                                    </div>  
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Username</label>
                                    <div class="col-md-12">
                                         <input type="text" name="username" class="form-control" placeholder="admin name" required value="<?php echo $username; ?>" required>
                                      </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" name="email" class="form-control" placeholder="e-mail address" required value="<?php echo $email; ?>" required >
                                   </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-md-12">Address</label>
                                      <div class="col-md-12">
                                           <input type="text" name="address" class="form-control" placeholder="admin address" required value="<?php echo $address; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-md-12">Birthday</label>
                                      <div class="col-md-12">
                                          <input type="date" name="birthday" class="form-control form-control-line" placeholder="MM/DD/YYYY" required value="<?php echo $birthday; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                         <input type="file" name="photo_admin"></div>
                                      </div>
                                  </div>
                              </div>
