                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box"> 
                            <div class="topnav">
                              ...
                              <?php 
                                $mId = $_POST["search"]; 
                                $query = "SELECT * FROM tb_member WHERE member_id LIKE '%$mId%' OR member_name LIKE '%$mId%'";
                                $result = mysqli_query($conn, $query);
                                
                                $number = mysqli_num_rows($result);
                                if($number==0){
                                  echo "<script>alert('No data found! Please, try again!');location.href='member.php';</script>";
                                }
                                ?>     
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td><a href="detailMember.php?member_id=<?php echo $data['member_id']; ?>"><button type="button" class="btn btn1-success" title="detail"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"></i></button>
                                            ...
                                            <a href="deleteMember.php?member_id=<?php echo $data['member_id']; ?>"><button type="button" class="btn btn3-danger" title="delete"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></button></a></td>
                                          </tr>
                                          <?php 
                                          } ?>
                                        </tbody>
