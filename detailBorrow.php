...
<section id="main-content">
        <div id="page-wrapper">
            ...
            <br>
            <br>  
            <h1>Detail Data Borrowed, 
            <strong>" 
            <?php 
              include 'connection.php';
              $query = "SELECT * FROM tb_databorrowed WHERE borrowing_code = '".$_GET['borrowing_code']."'"; 
              $result = mysqli_query($conn, $query); 
              $row = mysqli_fetch_array($result); 
           ...
           ?> "
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <?php
                      include 'connection.php';
                      $Cid = $_GET['borrowing_code'];
                      $query = "SELECT * FROM tb_databorrowed WHERE borrowing_code='$Cid'";
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Borrow Code</b></h5></label>
                                    <div class="col-md-12">
                                        <?php echo $data['borrowing_code']; ?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                ...
                                <hr>
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Borrow Date</b></h5></label>
                                    <div class="col-md-12">
                                        <?php echo $data['borrowed_date']; ?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Return Date</b></h5></label>
                                    <div class="col-md-12">
                                        <?php echo $data['returndate']; ?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                ...
                                <hr>
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Status</b></h5></label>
                                    <div class="col-md-12">
                        ...
                        <center><a href="borrow.php"><button type="button" class="btn btn1-success" title="back">Back To Home</button></a></center>
                        <br>
                        <br>
                    </div>
                </div>
