                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box"> 
                            ...
                            <?php 
                              ...
                              if($number==0){
                                echo "<script>alert('No data found! Please, try again!');location.href='borrow.php';</script>";
                              }
                              ?>            
                          ...
                          <table class="table">
                            ...
                            <tr>
                              ...
                              <a href="editBorrow.php?borrowing_code=<?php echo $data['borrowing_code']; ?>"><button type="button" class="btn btn2-warning" title="edit"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i></button></a>
                               <a href="processReturned.php?borrowing_code=<?php echo $data['borrowing_code']?>"><button type="button" class="btn btn3-danger" title="process"><i class="glyphicon glyphicon-ok" aria-hidden="true"></i></button></a></td>
                            </tr>
                            <?php 
                            } ?>
                          </tbody>
