...
<html lang="en">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-6 col-xs-12">
                      <div class="white-box analytics-info">  
                          ...
                          <br>
                          <center>
                              <span class="badge bg-theme"><i class="fa fa-thumb-tack" aria-hidden="true"></i>
                              &nbsp Library Fine</span>  
                              <br>
                              <br>
                  ...
                  <div class="col-md-12 col-lg-12 col-sm-12">
                      <div class="white-box"> 
                          <div class="topnav">
                              ...
                              <h2>Data Administrator &nbsp
                                  <a href="addNewAdmin.php"><button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i>&nbsp&nbspAdd New Admin</button></a>
                              </h2>
                              <br>
                              <br>  
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <button onclick="return confirm('Are you sure want to delete this data?')" type="button" class="btn btn3-danger" title="delete"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></button></a>
                                              </td>
                                          </tr>
                                          <?php } ?>
                                      </tbody>
  ...
  <script type="text/javascript" src="css/gritter/js/jquery.gritter.js"></script>
      <?php
        if($_SESSION['notice'] == 0){
      ?>
        <script type="text/javascript">
              $(document).ready(function () {
              var unique_id = $.gritter.add({
                  // (string | mandatory) the heading of the notification
                  title: 'Welcome to WildWood!',
                  // (string | mandatory) the text inside the notification
                  text: 'This web-based information system of WildWood Library will help the administrator to solve the problems in the library.',
