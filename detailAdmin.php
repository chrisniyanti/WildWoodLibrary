...
<html lang="en">
  <head>
    ...
    <title>Detail Admin - WildWood Library</title><link rel="shortcut icon" href="img/logo.png">
...
<section id="main-content">
        <div id="page-wrapper">
            ...
            <br>
            <br>  
            <h1>Detail Administrator, 
            <strong>
              <?php 
                  include 'connection.php';
                  $query = "SELECT * FROM tb_admin WHERE admin_id = '".$_GET['admin_id']."'"; 
                  $result = mysqli_query($conn, $query); 
                  $row = mysqli_fetch_array($result); 
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-md-4 col-xs-12">
                          <div class="white-box">
                            <div class="user-bg"><img src="<?php echo $data['photo_admin'];?>" width="100%" />
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Admin ID</b></h5></label>
                                    <div class="col-md-12">
                                        <?php echo $data['admin_id']; ?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                     <label class="col-md-12"><h5><b>Admin Name</b></h5></label>
                                    <div class="col-md-12">
                                        <?php echo $data['admin_name']; ?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label class="col-md-12"><h5><b>Username</b></h5></label>
                                    <div class="col-md-12">
                        ...
                        <center><a href="admin.php"><button type="button" class="btn btn1-success" title="back">Back To Home</button></a></center>
                        <br>
                        <br>
                    </div>
                </div>
