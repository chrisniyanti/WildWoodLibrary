                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                     ...
                     <h1>Searched Result</h1>
                      <br>
                        ...
                        <?php 
                          $book_id = $_POST["searched"]; 
                          $query = "SELECT * FROM tb_book WHERE book_id LIKE '%$book_id%' OR book_name LIKE '%$book_id%' OR category LIKE '%$book_id%'";
                          $result = mysqli_query($conn, $query);
                          
                          $number = mysqli_num_rows($result);
                          if($number==0){
                            echo "<script>alert('No data found! Please, try again!');location.href='book.php';</script>";
                          }
                          ?>
                        ...
                        <thead>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <a href="deleteBook.php?book_id=<?php echo $data['book_id']; ?>"><button type="button" class="btn btn3-danger" title="delete"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></button></a></td>
                            </tr>
                            <?php }
