...
<html lang="en">
  <head>
    ...
    <title>Book Returned - WildWood Library</title><link rel="shortcut icon" href="img/logo.png">
    <!-- Bootstrap core CSS -->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <br>
                <p class="centered">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="return.php" >
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box"> 
                          ...
                          <?php 
                            ...
                            if($number==0){
                              echo "<script>alert('No data found! Please, try again!');location.href='return.php';</script>";
                            }
                            ?>                  
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td><?php echo $data['status'] ?></td>
                                ...
                                <td>
                              <a href="deleteReturn.php?borrowing_code=<?php echo $data['borrowing_code']; ?>"><button type="button" class="btn btn3-danger" title="delete"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></button></a></td>
                            </tr>
                            <?php 
                            } ?>
                          </tbody>
