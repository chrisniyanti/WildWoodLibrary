...
<html lang="en">
  <head>
    ...
    <title>Edit Borrow Data - WildWood Library</title><link rel="shortcut icon" href="img/logo.png">
       ...
       <section id="main-content">
          <section class="wrapper"> 
                ...
                <div class="col-lg-9">
                  ...
                  <br>
                  <br>
                  <center><h1>Edit Borrow Data</h1></center>
                    <?php 
                      include 'connection.php';
                      $query=mysqli_query ($conn, "SELECT * FROM tb_databorrowed WHERE borrowing_code='$_GET[borrowing_code]'");
                      while($data=mysqli_fetch_array($query)){
                          $Cid              = $data['borrowing_code'];
                          $bId              = $data['book_id'];
                          $sId              = $data['student_id'];
                          $name             = $data['member_name'];
                          $title            = $data['book_name'];
                          $category         = $data['category'];
                          $borrow_date      = $data['borrowed_date'];
...
<!--main content start-->
      <section id="main-content form">     
             <div class="row">   
                        <div class="white-box">
                            <center><h3><i class="glyphicon glyphicon-open"></i>&nbspForm Edit Borrowed Data&nbsp<i class="glyphicon glyphicon-open"></i></h3><p>Please, input the correct and valid data</p></center>
                            <br>    
                            <form enctype="multipart/form-data" class="form-horizontal form-material" method="POST" action="editBorrowexe.php">
                                <div class="form-group">
                                    <label class="col-md-12">Borrow Code</label>
                                    <div class="col-md-12">
                                  <input type="text" name="Cid" class="form-control" placeholder="borrow code" value="<?php echo $Cid; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Book ID</label>
                                    <div class="col-md-12">
                                  <input type="text" name="bId" class="form-control" placeholder="book ID" value="<?php echo $bId; ?>" required>
                                    </div>  
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                  <input type="text" name="title" class="form-control" placeholder="book title" required value="<?php echo $title; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                  <input type="date" name="borrow_date" class="form-control" placeholder="MM/DD/YYYY" required value="<?php echo $borrow_date; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-md-12">Return Date</label>
                                    <div class="col-md-12">
                                  <input type="date" name="return" class="form-control" placeholder="MM/DD/YYYY" required value="<?php echo $return; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-md-12">Total Borrow</label>
                                    <div class="col-md-12">
                                        <input type="text" name="total" class="form-control" placeholder="total borrow" required value="<?php echo $total; ?>" readonly >
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-md-12">Status</label>
                                    <div class="col-md-12">
                                      <input type="text" name="status" class="form-control" placeholder="status" required value="<?php echo $status; ?>" readonly >
                                      </div>
                                  </div>
                                  <div class="form-group">
