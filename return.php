                            ...
                            <div class="table-responsive">
                                <table class="table">
                                  <thead>
                                    ...
                                    <tbody>
                                      <?php
                                        $query = "SELECT * FROM tb_databorrowed WHERE status ='returned'";
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $data['status'] ?></td>
                                          ...
                                          <td>
                                        <a href="deleteReturn.php?borrowing_code=<?php echo $data['borrowing_code']; ?>"><button onclick="return confirm('Are you sure want to delete this data?')" type="button" class="btn btn3-danger" title="delete"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></button></a></td>
                                      </tr>
                                      <?php } ?>
                                    </tbody>
                                  </table>
