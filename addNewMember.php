...
<html lang="en">
  <head>
    ...
    <title>Add New Member - WildWood Library</title><link rel="shortcut icon" href="img/logo.png">
 ...
 <!--main content start-->
      <section id="main-content form">     
             <div class="row">   
                        <div class="white-box">
                            <center><h3><i class="glyphicon glyphicon-user"></i>&nbspForm New Member&nbsp<i class="glyphicon glyphicon-user"></i></h3><p>Please, input the correct and valid data</p></center>
                            <br>    
                            <form enctype="multipart/form-data" class="form-horizontal form-material" method="post" action="addNewMemberexe.php">
                          ...
                          <div class="form-group">
                              <label class="col-md-12">totalal</label>
                                    <div class="col-md-12">
                                  <input type="text" name="total" class="form-control" placeholder="total book borrowed" >
                              </div>
                          </div>
                          <div class="form-group">
